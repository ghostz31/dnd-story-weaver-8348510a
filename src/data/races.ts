...
export const races: Race[] = [
        ...
        subraces: [
            {
                ...
                abilityBonuses: {}, // +1/+1 à choisir
                speed: 30,
                size: 'Moyen',
                traits: ['Polyvalent', 'Don au niveau 1'],
                languages: ['Commun', 'Une langue au choix'],
            }
        ]
    },
    ...
    // ─── EEPC / MotM ─────────────────────────────────────────────
    {
        ...
        speed: 30,
        size: 'Moyen',
        traits: ['Vol', 'Bec et plume', 'Serre'],
        languages: ['Commun', 'Aarakocra', 'Aérien'],
        traitDetails: {
            'Vol': 'Vitesse de vol de 15 m. Vous ne pouvez pas porter d\'armure moyenne ou lourde.',
            'Serre': 'Vos ailes et serres font partie de votre corps. Vous maîtrisez vos armes naturelles (1d4 tranchants).',
        },
    },
    {
        id: 'aasimar',
        ...
        speed: 30,
        size: 'Moyen',
        traits: ['Ascendance céleste', 'Guérison divine', 'Vision dans le noir'],
        languages: ['Commun', 'Céleste'],
        traitDetails: {
            'Ascendance céleste': 'Vous avez un héritage céleste. Au niveau 3 : soins légers 1/repos long. Au niveau 5 : rayon de soleil 1/repos long.',
            'Guérison divine': 'Vous pouvez relancer un dé de dégâts et garder le meilleur résultat (1 utilisation/repos long).',
            'Vision dans le noir': 'Vous pouvez voir à 18 m dans la lumière faible et l\'obscurité comme si c\'était la lumière vive.',
        },
    },
    {
        id: 'centaur',
        ...
        speed: 40,
        size: 'Moyen',
        traits: ['Charge', 'Homme-lézard', 'Sabots ferrés'],
        languages: ['Commun', 'Sylvestre'],
        traitDetails: {
            'Charge': 'Si vous vous déplacez d\'au moins 9 m en ligne droite vers une cible, celle-ci doit réussir un JS de DEX (DD 8+FOR+BM) ou être renversée.',
            'Homme-lézard': 'Vous pouvez utiliser votre corps léonin pour supporter des charges. Vous avez un avantage aux tests de Force (Athlétisme) pour grimper.',
            'Sabots ferrés': 'Attaque de sabot : 1d6 contondant. Vous êtes expert dans le maniement des lances et des arcs.',
        },
    },
    {
        id: 'changeling',
        ...
        speed: 30,
        size: 'Moyen',
        traits: ['Fausse apparence', 'Peau changeante', 'Voix imitatrice'],
        languages: ['Commun', 'Deux autres langues'],
        traitDetails: {
            'Fausse apparence': 'Vous pouvez changer d\'apparence pour ressembler à n\'importe quel humanoïde de votre taille (action). Vos Stats restent les mêmes.',
            'Peau changeante': 'Vous avez un bonus de +5 aux tests de Tromperie pour vous faire passer pour quelqu\'un d\'autre.',
            'Voix imitatrice': 'Vous pouvez imiter les sons vocaux et les paroles que vous avez entendues (JS de Tromperie pour éviter détection).',
        },
    },
    {
        id: 'genasi',
        ...
        subraces: [
            {
                ...
                abilityBonuses: { dex: 1 },
                traits: ['Souffle sans fin', 'Se mêler au vent'],
            },
            {
                id: 'earth-genasi',
                name: 'Génasi de la terre',
                abilityBonuses: { str: 1 },
                traits: ['Marche de la terre', 'Fusionner avec la pierre'],
            },
            {
                id: 'fire-genasi',
                name: 'Génasi du feu',
                abilityBonuses: { int: 1 },
                traits: ['Vision dans le noir (rouge)', 'Résistance au feu', 'Atteindre le brasier'],
            },
            {
                id: 'water-genasi',
                name: 'Génasi de l\'eau',
                abilityBonuses: { wis: 1 },
                traits: ['Résistance à l\'acide', 'Amphibie', 'Nage', 'Appeler la vague'],
            },
        ],
    },
    {
        ...
        speed: 30,
        size: 'Moyen',
        traits: ['Ascendance nécrotique', 'Éclipsé par l\'ombre', 'Fil de l’anneau'],
        languages: ['Commun', 'Elfe'],
        traitDetails: {
            'Ascendance nécrotique': 'Vous êtes lié à l\'Ombre. Au niveau 3 : sorts de nécromancie gratuits (1/repos long).',
            'Éclipsé par l\'ombre': 'Action bonus : devenez invisible jusqu\'à la fin du tour (1/repos long).',
            'Fil de l’anneau': 'Vous pouvez utiliser votre réaction pour transformer une attaque qui vous touche en échec et vous déplacer de 3 m.',
        },
    },
    {
        id: 'goblin',
        ...
        speed: 30,
        size: 'Petit',
        traits: ['Furtif', 'Éveillé', 'Morsure', 'Nimbe de feu'],
        languages: ['Commun', 'Gobelours'],
        traitDetails: {
            'Furtif': 'Vous avez un avantage sur les tests de Discrétion lorsque vous êtes à 3 m ou moins d\'une créature hostile.',
            'Éveillé': 'Vous n\'avez pas besoin de dormir. Vous pouvez faire un long repos en 4 heures.',
            'Morsure': 'Votre morsure est une arme naturelle infligeant 1d6 dégâts perforants.',
            'Nimbe de feu': 'Vous pouvez lancer Projectile de feu 1/repos long - créatures à 3 m : 1d6 feu, JS DEX DD 8+BM+MOD.',
        },
    },
]
